...
/**
 * Level2 to product relation
 *
 * @Decorator\Depend ("QSL\Make")
 */
class Level2Product extends \XLite\Module\QSL\Make\Model\Level2Product implements \XLite\Base\IDecorator, IndexingEventTriggerInterface
{
