...
/**
 * Level3 to product relation
 *
 * @Decorator\Depend ("QSL\Make")
 */
class Level3Product extends \XLite\Module\QSL\Make\Model\Level3Product implements \XLite\Base\IDecorator, IndexingEventTriggerInterface
{
