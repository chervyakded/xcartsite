...
class Banner extends \XLite\Model\Repo\ARepo
{
    ...
    const P_PAGE_ID           = 'pageId';
    const P_MEMBERSHIP_ID     = 'membershipId';
    const P_LOCATION          = 'location';
    const P_HOMEPAGE          = 'homePage';
    const P_PRODUCTS_PAGES    = 'productsPages';
    const P_PARALLAX          = 'parallax';
    ...
    {
        if (is_object($value) && $value instanceOf \XLite\Module\CDev\SimpleCMS\Model\Page) {
