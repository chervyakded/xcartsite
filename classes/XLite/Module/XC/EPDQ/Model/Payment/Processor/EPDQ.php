...
class EPDQ extends \XLite\Model\Payment\Base\WebBased
{
    ...
    protected function getFormFields()
    {
        ...
        $fields = array(
            ...
            // Customer name
            'CN'            => preg_replace( '/[^A-Za-z\s]/', '', $customerName),
            'EMAIL'         => $this->getProfile()->getLogin(),
            'OWNERZIP'      => $this->getProfile()->getBillingAddress()->getZipcode(),
            'OWNERADDRESS'  => $this->convertStringToUTF8Codes($this->getProfile()->getBillingAddress()->getStreet()),
            'OWNERCTY'      => $this->getProfile()->getBillingAddress()->getCountry()->getCode(),
            'OWNERTOWN'     => $this->convertStringToUTF8Codes($this->getProfile()->getBillingAddress()->getCity()),
