...
{
    /**
     * Is used to mark an profile as temporal
     */
    const MAILCHIMP_TEMP_PROFILE_COMMENT = 'this is temp profile has been created in order to subscribe an anonymous email to mailchimp and is subjected to be eliminated in the end';
