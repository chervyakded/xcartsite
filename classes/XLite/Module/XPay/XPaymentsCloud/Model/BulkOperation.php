 ...
 *
 * @Entity
 * @Table  (name="xpayments_bulk_operations")
 */
class BulkOperation extends \XLite\Model\AEntity
{
     ...
     *
     * @Id
     * @Column (type="integer", options={ "comment": "Order id" })
     */
    protected $order_id;
     ...
     *
     * @Id
     * @Column (type="string", length=32, options={ "comment": "XPID" })
     */
     ...
     *
     * @Id
     * @Column (type="string", length=20, options={ "comment": "Order operation code" } )
     */
     ...
     * @var string
     *
     * @Column (type="string", length=20, options={ "comment": "Order operation status" })
     */
     ...
     * @var string
     *
     * @Column (type="string", length=32, options={ "comment": "Batch operation ID" })
     */
    protected $batchId = '';
     ...
     *
     * @return \XLite\Module\XPay\XPaymentsCloud\Model\BulkOperation
     */
