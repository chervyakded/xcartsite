...
class __TwigTemplate_ac7c4854ab3a1ccfd20933f4135fcae85dabedf9cc5a2de447b942c5a50b7be6 extends \XLite\Core\Templating\Twig\Template
{
...
<xlite-file-uploader inline-template {% if this.hasMultipleSelector() %}:multiple=\"true\"{% endif %}
  ...
  <div class=\"{{ this.getDivStyle() }}\"
       ...
       \"initialAlt\":\"{% if this.hasAlt() %}{{ this.getAlt()|escape('js') }}{% endif %}\",
...
", "file_uploader/body.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\common\\file_uploader\\body.twig");
    }
}
