...
/* C:\OpenServer\domains\xcartsite\skins\admin\center.twig */
class __TwigTemplate_e3abf106a931effc76ca528f819705c1b9b90209c778bef77750d76282538a01 extends \XLite\Core\Templating\Twig\Template
{
...
echo $templateWrapperStart;
        ...
        // line 6
        $this->loadTemplate("noscript.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\center.twig", 6)->display($context);
        if ($templateWrapperText) {
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("access_denied.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\center.twig", 21)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
echo $templateWrapperStart;
            ...
            $this->loadTemplate("license_message.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\center.twig", 25)->display($context);
            if ($templateWrapperText) {
                echo $this->getThis()->endMarker($fullPath, $templateWrapperText);
            }
        }
...
";
    ...
    {
        return "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\center.twig";
    }
    ...
    {
        return new Source("", "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\center.twig", "");
    }
}
