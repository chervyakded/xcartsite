...
class __TwigTemplate_34a40d3a8af43f154685d7a74af44a02b9d0a0609e37824bb30c719d690b9a38 extends \XLite\Core\Templating\Twig\Template
{
    ...
    <div class=\"button\">
      {% if this.isLocalHost() %}
        {{ widget('XLite\\\\View\\\\Button\\\\Link',
          location=this.buildUrl('paypal_commerce_platform_settings'),
          label=t('Launch (Paypal Onboarding)'),
          blank='true'
        ) }}
      {% else %}
        {{ widget('\\\\XLite\\\\Module\\\\CDev\\\\Paypal\\\\View\\\\Button\\\\PaypalCommercePlatformOnboarding', label=t('Launch (Paypal Onboarding)')) }}
      {% endif %}
    </div>
    {% endif %}
  </div>
</xlite-onboarding-paypal-card>", "modules/CDev/Paypal/onboarding/paypal_commerce_platform/body.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\modules\\CDev\\Paypal\\onboarding\\paypal_commerce_platform\\body.twig");
    }
}
