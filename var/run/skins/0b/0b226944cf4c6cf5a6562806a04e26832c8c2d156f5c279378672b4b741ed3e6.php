...
class __TwigTemplate_b768b0d5ee1b2327667872587917333c02a1e7112b412d0657e114b200428c85 extends \XLite\Core\Templating\Twig\Template
{
...
<div
  ...
  :transition=\"stepTransition\">
  <xlite-wizard-step-product-added inline-template :demo-catalog=\"{{ this.isDemoCatalogAvailable() ? 'true' : 'false' }}\" product-url-base=\"{{ this.getStorefrontUrlBase() }}\">
...
</div>", "modules/XC/Onboarding/wizard_steps/product_added/body.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\modules\\XC\\Onboarding\\wizard_steps\\product_added\\body.twig");
    }
}
