...
class __TwigTemplate_ae4d9061f86acc7477f257601cd14f1bb73657d2d41503fb8128de7e97ab4268 extends \XLite\Core\Templating\Twig\Template
{
...
{% endif %}
  ...
  <div class=\"model form buttons\">
    <button type=\"button\" class=\"btn regular-button\" @click.prevent=\"doUploadViaUrl\">{{ t('Upload') }}</button>
  </div>
</div>
", "file_uploader/parts/menu.upload.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\common\\file_uploader\\parts\\menu.upload.twig");
    }
}
