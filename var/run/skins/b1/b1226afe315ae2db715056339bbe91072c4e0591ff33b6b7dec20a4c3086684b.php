...
class __TwigTemplate_711e643565b3dde38f1ebd27a6632bbcf0ea3c9fe7aa02c7f6e8c2472f2f508a extends \XLite\Core\Templating\Twig\Template
{
...
($context["errorMessage"] ?? null)) {
  ...
  ";
    ...
    {
        return new Source("{% use \"twig_form/bootstrap_3_horizontal_layout.html.twig\" %}
...
{% block form_row -%}
  {% spaceless %}
    <div class=\"{{ block('form_row_class') }}
        ...
        {% if v_validators|length > 0 %} v-bind:class=\"{{ '{' }} 'has-error': {{ v_validator }}.invalid && ( {{ v_form }}.submitted || {{ v_validator }}.dirty ) {{ '}' }}\" {% endif %}
      ...
      <div class=\"help-block\">
        <ul class=\"list-unstyled field-errors\">
          ...
          {%- for validator in v_validators -%}
            <li v-if=\"{{ validator }} && ( {{ v_form }}.submitted || {{ v_validator }}.dirty )\" v-text=\"{{ validator }}\"></li>
          {%- endfor -%}
        </ul>
      </div>
    {% endif %}
...
{% block clean_url_widget -%}
  ...
  <div class=\"clean-url-result help-block not-padded\"
    ...
    <div class=\"clean-url-result-info\" v-else>{{ t('The clean URL will be generated automatically.') }}</div>
  </div>
...
{# /file_uploader #}
", "form_model/theme.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\form_model\\theme.twig");
    }
}
