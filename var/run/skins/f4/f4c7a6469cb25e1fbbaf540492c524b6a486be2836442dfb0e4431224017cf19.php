...
class __TwigTemplate_2f98fff6e03f23fd51bfef8ba2a83ad059cf7a118d435d8239693c4d08362c87 extends \XLite\Core\Templating\Twig\Template
{
  ...
  <xlite-wizard-step-payment inline-template>
    <div class=\"step-contents\">
      ...
      <div class=\"methods\">
        ...
        {% for widgetClass in this.getOnlineWidgetsSorted() %}
          {{ widget(widgetClass) }}
        {% endfor %}

        <div class=\"offline\">
          <div class=\"method-name\">
            {{ t('Find your payment method') }}

            <div class=\"method-type\">
              {{ t('We support 120+ payment gatewayes') }}
            </div>
          </div>

          <div class=\"button\">
            <a class=\"btn regular-button\" href=\"{{ this.getMoreSettingsLocation() }}\" target=\"_blank\">
              <span>{{ t('Search') }}</span>
            </a>
          </div>
        </div>
...
</div>", "modules/XC/Onboarding/wizard_steps/payment/body.twig", "C:\\OpenServer\\domains\\xcartsite\\skins\\admin\\modules\\XC\\Onboarding\\wizard_steps\\payment\\body.twig");
    }
}
