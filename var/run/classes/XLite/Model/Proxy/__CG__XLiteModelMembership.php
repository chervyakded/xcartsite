...
class Membership extends \XLite\Model\Membership implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'coupons', 'saleDiscounts', 'banners', 'membership_id', 'position', 'enabled', 'quickData', 'categories', 'products', 'editLanguage', 'translations', '_previous_state'];
        }
