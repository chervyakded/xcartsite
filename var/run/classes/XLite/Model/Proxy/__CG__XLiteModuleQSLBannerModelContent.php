 ...
 */
class Content extends \XLite\Module\QSL\Banner\Model\Content implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'content_id', 'position', 'banner', 'editLanguage', 'translations', '_previous_state'];
        }
