...
namespace XLite\Model\Proxy\__CG__\XLite\Module\QSL\Banner\Model\Image\Banner;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \XLite\Module\QSL\Banner\Model\Image\Banner\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'bannerSlide', 'alt', 'width', 'height', 'hash', 'needProcess', 'includeFilenameInHash', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError', 'loadErrorMessage', '_previous_state'];
        }
    ...
    public function setBannerSlide(\XLite\Module\QSL\Banner\Model\BannerSlide $bannerSlide = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBannerSlide', [$bannerSlide]);

        return parent::setBannerSlide($bannerSlide);
    }
