...
class Page extends \XLite\Module\CDev\SimpleCMS\Model\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'useCustomOG', 'ogMeta', 'showSocialButtons', 'banners', 'id', 'enabled', 'image', 'cleanURLs', 'metaDescType', 'position', 'editLanguage', 'translations', '_previous_state'];
        }
    ...
    public function addBanners(\XLite\Module\QSL\Banner\Model\Banner $banners)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBanners', [$banners]);

        return parent::addBanners($banners);
    }
