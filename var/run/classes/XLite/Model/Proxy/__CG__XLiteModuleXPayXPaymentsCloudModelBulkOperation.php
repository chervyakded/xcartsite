...
namespace XLite\Model\Proxy\__CG__\XLite\Module\XPay\XPaymentsCloud\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class BulkOperation extends \XLite\Module\XPay\XPaymentsCloud\Model\BulkOperation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'order_id', 'xpaymentsId', 'operation', 'status', 'batchId', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BulkOperation $proxy) {
    ...
    public function setXpaymentsId($xpaymentsId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setXpaymentsId', [$xpaymentsId]);

        return parent::setXpaymentsId($xpaymentsId);
    }
