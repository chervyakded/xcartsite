 ...
 */
class ContentTranslation extends \XLite\Module\QSL\Banner\Model\ContentTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'content', 'label_id', 'code', 'owner', '_previous_state'];
        }
