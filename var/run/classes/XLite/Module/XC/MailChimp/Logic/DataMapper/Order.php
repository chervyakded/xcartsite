...
class Order
{
    ...
    public static function getDataByOrder($mc_cid, $mc_tc, \XLite\Model\Order $object)
    {
        ...
        $return = [
            ...
            'processed_at_foreign' => gmdate('c', $object->getDate()),
            'updated_at_foreign'   => gmdate('c', $object->getLastRenewDate()),
        ];
    ...
    public static function getUpdateDataByOrder(\XLite\Model\Order $order)
    {
        ...
        $return = [
            ...
            'processed_at_foreign' => gmdate('c', $order->getDate()),
            'updated_at_foreign'   => gmdate('c', $order->getLastRenewDate()),
        ];
