 ...
 * Banner view model
 */
abstract class BannerAbstract extends \XLite\View\Model\AModel
{
    /**
     * Shema default
     *
    ...
    protected $schemaDefault = [
        'location'       => [
            self::SCHEMA_CLASS    => 'XLite\Module\QSL\Banner\View\FormField\Select\SelectLocation',
        ...
        'effect'         => [
            self::SCHEMA_CLASS    => 'XLite\Module\QSL\Banner\View\FormField\Select\SelectEffect',
    ...
    protected function getDefaultModelObject()
    {
        $model = $this->getModelId()
            ? \XLite\Core\Database::getRepo('XLite\Module\QSL\Banner\Model\Banner')->find($this->getModelId())
            : null;

        return $model ?: new \XLite\Module\QSL\Banner\Model\Banner;
    }
    ...
    {
        return '\XLite\Module\QSL\Banner\View\Form\Model\Banner';
    }
