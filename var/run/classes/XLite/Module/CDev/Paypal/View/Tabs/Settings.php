...
class Settings extends \XLite\View\Tabs\ATabs
{
    ...
    public static function getAllowedTargets()
    {
        ...
        if (in_array(\XLite\Core\Config::getInstance()->Company->location_country, \XLite\Module\CDev\Paypal\Main::PP_PAYPAL_CREDIT_COUNTRIES, true)) {
            $list[] = 'paypal_credit';
        }
    ...
    protected function prepareTabs()
    {
        ...
        if ($rightController
            ...
            && (!in_array(\XLite\Core\Config::getInstance()->Company->location_country, \XLite\Module\CDev\Paypal\Main::PP_PAYPAL_CREDIT_COUNTRIES, true)
