...
use XLite\Module\XPay\XPaymentsCloud\View\FormField\Select\ShowCardInfoOnInvoicePage;
 ...
 class Invoice extends \XLite\View\InvoiceAbstract implements \XLite\Base\IDecorator
{
    ...
    {
        switch (Config::getInstance()->XPay->XPaymentsCloud->show_card_info_on_invoice_page) {
            case ShowCardInfoOnInvoicePage::SHOW_TO_EVERYONE:
                $result = true;
                break;
            case ShowCardInfoOnInvoicePage::SHOW_TO_ADMIN_ONLY:
                $result = Auth::getInstance()->isAdmin();
                break;
