...
class BuyWithWallet extends \XLite\View\Product\Details\Customer\Widget
{
    ...
    protected function isVisible()
    {
        return
            parent::isVisible()
            && \XLite\Module\XPay\XPaymentsCloud\Core\Wallets::isCheckoutWithWalletEnabled($this->getParam(self::PARAM_WALLET_ID));
    }
    ...
    {
        return '\\XLite\\Module\\XPay\\XPaymentsCloud\\View\\Button\\Product\\' . $this->getParam(self::PARAM_WALLET_CLASS);
    }
