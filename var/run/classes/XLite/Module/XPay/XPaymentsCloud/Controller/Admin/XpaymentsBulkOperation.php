...
class XpaymentsBulkOperation extends \XLite\Controller\Admin\AAdmin
{
    ...
    {
        $this->batchId = \XLite\Core\Database::getRepo('XLite\Module\XPay\XPaymentsCloud\Model\BulkOperation')
    ...
    protected function getOrdersData()
    {
        ...
        $operations = \XLite\Core\Database::getRepo('\XLite\Module\XPay\XPaymentsCloud\Model\BulkOperation')->findAll();
