...
class Plan extends Base\ASubscriptionPlan
{
     ...
     * @var int
     *
     * @Column (type="integer", options={ "default": 0, "comment": "Trial duration (in days / weeks / months / years)" })
     */
     ...
     * @var string
     *
     * @Column (type="string", options={ "fixed": true, "default": "D" }, length=1)
     */
     ...
     * @var boolean
     *
     * @Column (type="boolean", options={ "default": false, "comment": "Has trial period or not" })
     */
