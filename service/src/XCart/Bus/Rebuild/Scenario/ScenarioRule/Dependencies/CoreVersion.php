    ...
    public function applyFilter(TransitionInterface $transition, ScenarioBuilder $scenarioBuilder): void
    {
        ...
        foreach ($this->getDependencies($transition) as $dependency) {
            ...
            if ($dependencyModule) {
                ...
                if ($module) {
                    $isEnabledAfter = $transition->getStateAfterTransition($module->toArray())['enabled'];
                }
            ...
            } elseif ($transition instanceof EnableTransition || $transition instanceof InstallEnabledTransition) {
