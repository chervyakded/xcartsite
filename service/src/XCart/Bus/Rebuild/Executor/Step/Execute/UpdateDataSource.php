 ...
 * @RebuildStep(script = "major-upgrade", weight = "9000")
 */
            ...
            foreach ($state->remainTransitions as $key => $transition) {
                ...
                if ($module) {
                    ...
                    if (isset($stateAfter['installed']) && $stateAfter['installed'] === false) {
                        ...
                        // Version for the сore and modules should stay previous for the major upgrade.
                        // It is necessary to determine of the versionFrom on the 5.5 side
                        if (version_compare($stateAfter['version'], '5.5', '>=')) {
                            $stateAfter['version'] = $module['version'];
                        }
