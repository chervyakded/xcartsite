 ...
 * @see \XCart\Bus\Rebuild\Executor\Step\Execute\ConvertConfiguration
 ...
 * @RebuildScript(name="major-upgrade")
 */
class MajorUpgradeScript extends AScript
{
    /**
    ...
    {
        return $scriptState->type === 'major-upgrade' && $scriptState->isExecutable();
    }
}
