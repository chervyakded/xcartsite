...
class MarketplaceModulesDataSource extends AMarketplaceCachedDataSource
{
     ...
     * @return bool
     */
    public function isVersionExistsInMarketplace($id, $version): bool
    {
        $modules = $this->findInMarketplace($id);
     ...
     * @return array
     */
    public function getAllFromMarketplace(): array
    {
     ...
     * @return mixed
     */
    public function findInMarketplace($id)
    {
        $data = $this->getAllFromMarketplace();
