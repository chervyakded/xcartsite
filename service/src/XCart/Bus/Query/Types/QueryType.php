    ...
    protected function defineConfig()
    {
        return [
            ...
            'fields' => [
                ...
                'errorRequirements'                 => [
                    'type'    => Type::listOf(Type::string()),
                    'resolve' => $this->app[UpgradeResolver::class . ':getErrorRequirements'],
                ],
                'enabledModulesWithoutMajorUpgrade' => [
                    'type'    => Type::listOf($this->app[ModuleType::class]),
                    'resolve' => $this->app[UpgradeResolver::class . ':getEnabledModulesWithoutMajorUpgrade'],
                ],
            ],
        ];
    }
